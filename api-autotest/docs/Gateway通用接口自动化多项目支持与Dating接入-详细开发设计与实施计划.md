...
**Goal:** 在保留现有 Gateway 执行能力和测试开发平台接入能力的基础上，把 `api-autotest` 改造成集中式多项目接口自动化工具，完成 Truthy 标准化迁移、Dating test 首期接入、七类 Web 页面以及平台 Runtime Scope 控制面建设。

**Architecture:** 测试开发平台是运行配置、Release、Secret/Credential、身份权限与 Runtime Scope 的唯一真源；`api-autotest/projects/<project_id>/` 是 API、Case、Flow、Scenario 与 fixture 测试资产的唯一真源。平台通过版本化 Runtime Scope/快照契约向工具下发不可变运行配置；工具在当前项目上下文中收集、执行并隔离任务、日志和报告。
...
- 接口自动化页面、项目资产、任务 API、任务状态机、执行、日志与报告仍位于 `api-autotest`；平台只承载入口、身份、RBAC、Runtime Scope 和配置控制面。
...
| 代码范围 | `api-autotest/`、`test-platform/` |
...
flowchart LR
    ...
    P -->|签名用户与平台项目上下文| W[api-autotest Web]
    U --> C[平台配置控制面]
    C --> A[平台配置 API]
...
- Create: `api-autotest/utils/custom/project_registry.py`
- Modify: `api-autotest/utils/custom/api_loader.py`
- Modify: `api-autotest/utils/custom/case_loader.py`
- Modify: `api-autotest/utils/custom/flow_loader.py`
- Create: `api-autotest/tests/test_project_registry.py`
- Create: `api-autotest/tests/test_project_isolation.py`
...
- [ ] 运行 `cd api-autotest && python -m pytest tests/test_project_registry.py tests/test_project_isolation.py tests/test_catalog.py -q`。
...
- Modify: `api-autotest/utils/custom/config_loader.py`
- Modify: `api-autotest/utils/custom/runtime_context.py`
- Modify: `api-autotest/web/task_manager.py`
- Modify: `api-autotest/web/credentials.py`
- Create: `api-autotest/tests/test_runtime_config.py`
- Modify: `api-autotest/tests/test_task_manager.py`
...
- [ ] 运行 `cd api-autotest && python -m pytest tests/test_runtime_config.py tests/test_task_manager.py tests/test_web_routes.py -q`。
...
- Modify: `api-autotest/runtest.py`
- Modify: `api-autotest/test_cases/conftest.py`
- Create: `api-autotest/projects/truthy/project.yaml`
- Move: `api-autotest/data/**` → `api-autotest/projects/truthy/data/**`
- Move: Truthy 测试素材 → `api-autotest/projects/truthy/fixtures/**`
- Modify: `api-autotest/Jenkinsfile`（若参数位于其他 Jenkins 文件，以实际入口为准）
...
- [ ] 运行 `cd api-autotest && python -m pytest tests -q && python runtest.py --validate-projects`；真实 Gateway 用例在已配置环境单独运行。
...
- Modify: `api-autotest/web/task_store.py`
- Modify: `api-autotest/web/task_manager.py`
- Modify: `api-autotest/web/app.py`
- Modify: `api-autotest/scripts/publish_allure_report.sh`
- Modify: `api-autotest/scripts/fetch_jenkins_report.sh`
- Modify: `api-autotest/tests/test_task_store.py`
- Modify: `api-autotest/tests/test_report_scripts.py`
...
- [ ] 运行 `cd api-autotest && python -m pytest tests/test_task_store.py tests/test_task_manager.py tests/test_report_scripts.py tests/test_junit_report.py -q`。
...
- Create: `api-autotest/projects/dating/project.yaml`
- Create: `api-autotest/projects/dating/data/api/**`
- Create: `api-autotest/projects/dating/data/apis/**`
- Create: `api-autotest/projects/dating/data/cases/**`
- Create: `api-autotest/projects/dating/data/flows/**`
- Create: `api-autotest/projects/dating/data/scenarios/**`
- Create: `api-autotest/projects/dating/fixtures/**`
- Modify: `api-autotest/utils/custom/flow_runner.py`
- Create: `api-autotest/tests/test_dating_assets.py`
...
- [ ] 运行 `cd api-autotest && python -m pytest tests/test_dating_assets.py tests/test_project_isolation.py -q`。
...
- Modify: `api-autotest/web/app.py`
- Modify: `api-autotest/web/catalog.py`
- Modify: `api-autotest/web/credentials.py`
- Modify: `api-autotest/web/task_manager.py`
- Modify: `api-autotest/tests/test_web_routes.py`
- Modify: `api-autotest/tests/test_catalog.py`
...
- [ ] 运行 `cd api-autotest && python -m pytest tests/test_web_routes.py tests/test_catalog.py -q`。
...
- Create: `api-autotest/web/templates/base.html`
- Create: `api-autotest/web/templates/projects.html`
- Create: `api-autotest/web/templates/task_create.html`
- Create: `api-autotest/web/templates/task_history.html`
- Create: `api-autotest/web/static/app.css`
- Create: `api-autotest/web/static/app.js`
- Modify: `api-autotest/web/templates/index.html`
- Modify: `api-autotest/web/templates/catalog.html`
- Modify: `api-autotest/web/templates/task_detail.html`
- Modify: `api-autotest/web/app.py`
- Modify: `api-autotest/tests/test_web_routes.py`
...
- [ ] 运行 `cd api-autotest && python -m pytest tests/test_web_routes.py -q`。
...
- Modify: `api-autotest/Jenkinsfile` 及实际调用脚本
- Modify: `api-autotest/web/app.py`
...
- Create later deliverable: `api-autotest/docs/Gateway接口自动化新项目接入指南.md`
